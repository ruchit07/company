Public Class EmployeeDetail
    ...
    Private Sub EmployeeDetail_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        End If
        objEmployee.InsertEmployee(txtEmployeeNo.Text, txtCustomerName.Text, txtAddress.Text, intTalukoId, intJilloId, intRajyaId, txtPincode.Text, txtAdharno.Text, txtMobileNumber.Text, dtBirthDate.Value, dtResignDate.Value, dtJoiningDate.Value)
        Me.Hide()
        Dim form2 = New Employee()
        AddHandler form2.Closed, Sub(s, args) Me.Close()
